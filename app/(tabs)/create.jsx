...
const Create = () => {
  ...
  const openPicker = async (selectType) => {
    ...
    //   type: selectType === 'image' ? ['images/png','images/jpg'] : ['video/mp4','video/gif']
  ...
  const submit = async () => {
    if (!form.prompt || !form.title || !form.thumbnail || !form.video) {
      return Alert.alert("Please fill in all the form fields")
    }
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView className='px-4 my-6'>
          ...
          <FormField
            ...
            handleChangeText={(val) => setForm({ ...form, title: val })}
            otherStyles='mt-10'
          />
          ...
          <FormField
            ...
            handleChangeText={(val) => setForm({ ...form, prompt: val })}
            otherStyles='mt-7'
          />
          <CustomButton
            title='Submit & Public'
